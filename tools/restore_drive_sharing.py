...
service account but are no longer visible to REPLACED_EMAIL. It will:

1. List all files owned by the service account
2. Re-share them with REPLACED_EMAIL
...
if __name__ == "__main__":
    ...
    print("This will restore sharing permissions for REPLACED_EMAIL\n")
