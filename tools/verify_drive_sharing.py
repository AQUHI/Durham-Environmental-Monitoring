...
with REPLACED_EMAIL and provides recommendations for fixing any issues.
        ...
        if os.path.exists(config_path):
            ...
            try:
                with open(config_path, 'r') as f:
                    content = f.read()
                    if 'REPLACED_EMAIL' in content:
                        print("  ✅ Contains REPLACED_EMAIL")
                    else:
                        print("  ⚠️  Does not contain REPLACED_EMAIL")
...
def test_sharing():
    ...
    try:
        ...
        test_email = input("Enter an email to test sharing with (or press Enter for REPLACED_EMAIL): ").strip()
        if not test_email:
            test_email = 'REPLACED_EMAIL'
        ...
        if "inappropriate" in str(e).lower():
            ...
            print("      from the service account to REPLACED_EMAIL")
...
def main():
    ...
    if test_sharing():
        ...
        print("  2. REPLACED_EMAIL is a valid Gmail address")
