...
def check_shared_with_hotdurham():
    """Check what folders are currently shared with REPLACED_EMAIL"""
    
    print("📧 Checking folders shared with REPLACED_EMAIL...\n")
    ...
    try:
        ...
        # Search for folders where REPLACED_EMAIL has access
        ...
        for folder in folders:
            ...
            try:
                ...
                hotdurham_has_access = any(
                    perm.get('emailAddress') == 'REPLACED_EMAIL' 
...
def provide_recovery_instructions():
    ...
    print("🔍 **1. Search in REPLACED_EMAIL Google Drive:**")
    print("   - Log into https://drive.google.com with REPLACED_EMAIL")
...
def main():
    ...
    print(f"📧 Currently shared with REPLACED_EMAIL: {len(shared_folders)} folders")
    
    # Provide recovery instructions
    provide_recovery_instructions()
    
    print("\n🎯 **Next Steps:**")
    print("1. Check REPLACED_EMAIL Google Drive 'Shared with me'")
