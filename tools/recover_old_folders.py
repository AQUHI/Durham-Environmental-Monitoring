...
class OldFolderRecovery:
    def __init__(self):
        ...
        self.main_user_email = "REPLACED_EMAIL"
    ...
    def print_recovery_guide(self):
        ...
        print("\n📋 **Step 1: Check REPLACED_EMAIL Google Drive**")
        print("   1. Go to https://drive.google.com")
        print("   2. Log in with REPLACED_EMAIL")
        ...
        print("   2. Check REPLACED_EMAIL 'Shared with me'")
